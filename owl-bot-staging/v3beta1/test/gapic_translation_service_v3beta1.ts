...
describe('v3beta1.TranslationServiceClient', () => {
    ...
    describe('translateDocument', () => {
        it('invokes translateDocument without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.translation.v3beta1.TranslateDocumentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.translation.v3beta1.TranslateDocumentResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.translateDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('batchTranslateDocument', () => {
        it('invokes batchTranslateDocument without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.translation.v3beta1.BatchTranslateDocumentRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchTranslateDocument as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
