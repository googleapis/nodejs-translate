...
class TranslationServiceClient {
   ...
   *
   *   The second parameter to the callback is an object representing [TranslateTextResponse]{@link google.cloud.translation.v3.TranslateTextResponse}.
   ...
   *
   * const client = new translate.v3.TranslationServiceClient({
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [DetectLanguageResponse]{@link google.cloud.translation.v3.DetectLanguageResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [SupportedLanguages]{@link google.cloud.translation.v3.SupportedLanguages}.
   * @returns {Promise} - The promise which resolves to an array.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is Array of [Glossary]{@link google.cloud.translation.v3.Glossary}.
   *
   *   When autoPaginate: false is specified through options, it contains the result
   *   in a single response. If the response indicates the next page exists, the third
   *   parameter is set to be used for the next request object. The fourth parameter keeps
   *   the raw response object of an object representing [ListGlossariesResponse]{@link google.cloud.translation.v3.ListGlossariesResponse}.
   * @returns {Promise} - The promise which resolves to an array.
   *   The first element of the array is Array of [Glossary]{@link google.cloud.translation.v3.Glossary}.
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Glossary]{@link google.cloud.translation.v3.Glossary} in a single response.
   ...
   *   The function which will be called with the result of the API call.
   *
   *   The second parameter to the callback is an object representing [Glossary]{@link google.cloud.translation.v3.Glossary}.
   * @returns {Promise} - The promise which resolves to an array.
