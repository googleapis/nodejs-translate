...
async function getLanguages(target = null) {
    ...
    // Creates a client
    const translate = new Translate();
    const results = !target ? await translate.getLanguages() : await translate.getLanguages(target);
    const languages = results[0];
    console.log('Languages:');
    languages.forEach(language => console.log(language));
}

async function translate(text, target, model = null) {
