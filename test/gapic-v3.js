...
describe('TranslationServiceClient', () => {
  it('has servicePath', () => {
    const servicePath = translateModule.v3.TranslationServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = translateModule.v3.TranslationServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port = translateModule.v3.TranslationServiceClient.port;
    assert(port);
    assert(typeof port === 'number');
  });

  it('should create a client with no options', () => {
    const client = new translateModule.v3.TranslationServiceClient();
    assert(client);
  });
